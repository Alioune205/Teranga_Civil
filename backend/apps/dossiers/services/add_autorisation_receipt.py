...
def _draw_autorisation_receipt_content(p, width, height, dossier, cachet_path, signature_path, cachet_nominal_path, qr_image_reader):
    ...
    p.setFont("Helvetica", 10)
    p.drawString(6*cm, y, "Autorisation de construire")
    y -= 30
    ...
    docs = [
        "Acte administratif", "Acte de vente enregistré", "Plan de construction",
        "Plan cadastral", "Photocopie de la pièce d'identité",
        "Demande de bail / attestation de dépôt de bail", "Demande adressée au Maire",
        "Fiche de renseignements", "Devis descriptif du projet", "Plan de fosse septique",
        "Taxe d'urbanisme", "Taxe communale"
    ]
...
def generate_autorisation_receipt(dossier):
    ...
    _draw_autorisation_receipt_content(
