...
// ─── Composant Principal ─────────────────────────────────────────────────────
export default function FormulaireRegularisation({ citoyenId, citoyen: citoyenProp, paymentData, onSuccess, onCancel }) {
  ...
  const [fichiers, setFichiers] = useState({
    demande_regularisation_maire: null,
    piece_identite_requerant: null,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      payload.append('type_document', 'regularisation');
      ...
      payload.append('pieces_jointes', fichiers.demande_regularisation_maire);
      payload.append('pieces_jointes', fichiers.piece_identite_requerant);
      payload.append('pieces_jointes', fichiers.acte_original_terrain);
      ...
      let errorMessage = "Erreur lors de l'enregistrement de la demande de régularisation";
      ...
      <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-xl">
        ...
        <div className="flex-1">
          <h3 className="font-semibold text-blue-800 dark:text-blue-300 font-jakarta">
            Demande de Régularisation Foncier
          </h3>
          {loadingCitoyen ? (
      ...
      <div className="bg-amber-50/50 border border-amber-200 p-4 rounded-lg flex items-start gap-3">
        ...
        <div className="flex-1">
          <label htmlFor="dossier-physique" className="text-sm font-medium text-amber-900 cursor-pointer">
            J'atteste avoir reçu le dossier physique complet. *
          </label>
